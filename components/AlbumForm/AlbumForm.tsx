...
export default function AlbumForm({ initialTitle = "", initialCoverImg = null, onSubmit, formTitle, submitButtonText }: AlbumFormProps) {
  ...
  const {
    ...
    formState: { errors },
    getValues,
  } = useForm<Inputs>({ resolver: zodResolver(schema), defaultValues: { title: initialTitle }, });
